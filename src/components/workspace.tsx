    ...
    >
      <div className="flex min-h-screen">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          {/* 移动端导航 */}
          <div className="mobile-app-header sticky top-0 z-30 flex items-center justify-between gap-2 border-b border-border bg-background/95 px-4 py-3 backdrop-blur md:hidden">
          ...
          <nav
            aria-label={t("手机导航")}
            className="mobile-app-nav fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background md:hidden"
          >
            {mobileMore && (
              <div className="grid grid-cols-4 gap-1 border-b border-border p-2">
                {NAV.slice(4).map((item) => (
                  <button
                    ...
                    className={cn(
                      "flex min-h-14 flex-col items-center justify-center gap-1 rounded-lg text-xs",
            ...
            <div className="grid grid-cols-5 gap-1 px-2 py-1">
              ...
              <button
                ...
                className={cn(
                  "flex min-h-14 flex-col items-center justify-center gap-1 rounded-lg text-xs",
                  NAV.slice(4).some((item) => item.id === view) &&

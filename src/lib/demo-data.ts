...
const SEEDS: Seed[] = [
  ...
  ["江禾", "知行实验室", "实验室同门", "博士生", "机器学习", 4],
  ["夏知", "知行实验室", "课题组同门", "数据工程师", "数据清洗", 4],
  ["魏岚", "知行实验室", "合作课题成员", "统计师", "统计分析", 3],
  ["邱然", "知行实验室", "导师助理", "科研秘书", "会议协调", 3],
  ["宋清", "知行实验室", "论文合作者", "英文编辑", "学术写作", 4],
  ["杜衡", "知行实验室", "开源项目搭档", "算法工程师", "模型评测", 3],
  ["严可", "知行实验室", "访学认识", "交互研究员", "可用性测试", 3],
  ["白璐", "知行实验室", "会议志愿者", "会务负责人", "学术活动组织", 3],
  ["温言", "知行实验室", "校友导师", "投资经理", "创业辅导", 2],
  ["章驰", "知行实验室", "课程助教", "讲师", "技术教学", 3],
  ["叶青", "校园摄影社", "摄影社社长", "人像摄影师", "人像摄影", 5],
  ["程诺", "校园摄影社", "后期搭档", "视频剪辑师", "剪辑调色", 4],
  ["乔木", "校园摄影社", "器材管理员", "器材租赁顾问", "相机灯光", 3],
  ["段星", "校园摄影社", "活动搭档", "无人机飞手", "航拍", 3],
  ["米雪", "校园摄影社", "模特朋友", "造型师", "妆造搭配", 3],
  ["高远", "校园摄影社", "社团指导老师", "艺术教师", "视觉策划", 3],
  ["范雨", "校园摄影社", "展览搭档", "策展助理", "展览执行", 3],
  ["金澄", "校园摄影社", "音乐节认识", "现场导演", "舞台统筹", 2],
  ["石磊", "校园摄影社", "器材群认识", "灯光师", "舞台灯光", 2],
  ["姚桃", "校园摄影社", "短片搭档", "编剧", "故事策划", 3],
...
function demoPeople(): PersonRecord[] {
  return SEEDS.map(([name, collection, relation, title, skill, closeness], index) => ({
    ...
    profile: {
      ...
      relation,
      title,
      org: collection === "知行实验室" ? "知行实验室（模拟）" : `${collection}示范圈`,
      likes: [skill],

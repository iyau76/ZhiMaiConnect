...
export const SPEECH_VARIANTS: SpeechVariant[] = [
  ...
  },
  {
    ...
    iso: "zh",
    prompt:
      "以下是一段四川方言录音，请逐字转写成中文，保留「啥子」「要得」「巴适」「摆龙门阵」等方言词。",
  },
  {
    id: "northeast",
    zh: "东北话",
    ...
    iso: "zh",
    prompt:
      "以下是一段东北方言录音，请逐字转写成中文，保留「咋整」「贼」「唠嗑」「整挺好」等方言词。",
  },
  {
    id: "wu",
    zh: "上海话 / 吴语",
    ...
    iso: "zh",
    prompt:
      "以下是一段上海话（吴语）录音，请逐字转写成中文，保留「侬」「阿拉」「勿」「晓得」等吴语用词。",
  },
  {
    id: "minnan",
    zh: "闽南话",
    ...
    iso: "zh",
    prompt:
      "以下是一段闽南话录音，请逐字转写成中文，保留「汝」「毋」「按怎」「食饭」等闽南语用词。",
  },
  {
    id: "hakka",
    zh: "客家话",

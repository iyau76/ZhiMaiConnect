...
const EN: Record<string, string> = {
  ...
  日历: "Calendar",
  计划: "Plan",
  目标拆解与行动项: "Goals and action items",
  暂无职位: "No title yet",
  未分部门: "No group",
  未指定: "Unspecified",
  未指定负责人: "No owner",
  ...
  推导关系缺少可核验依据: "An inferred relation is missing auditable evidence",
  ...
  建立关系: "Link them",
  新建关系: "New relation",
  关系依据: "Relation evidence",
  "原文：… / 推断依据：…": "Original: … / Inference basis: …",
  原文关系: "Explicit relation",
  "AI 推断，已人工接受": "AI inference accepted by user",
  "AI 推断，经人工确认": "AI inference confirmed by user",
  未记录: "Not recorded",
  在图上连接两个人: "Connect two people on the graph",
  "依次点击图中的起点和终点，再输入任意关系名称；候选标签只是快捷建议。":
    "Pick the start and end nodes, then type any relation name; suggestions are only shortcuts.",
  取消新建关系: "Cancel new relation",
  起点: "Start",
  终点: "End",
  点击图中一个人物: "Pick a person on the graph",
  再点击另一个人物: "Pick another person",
  交换关系方向: "Reverse relation direction",
  关系名称: "Relation name",
  可自由输入新关系: "Type a custom relation",
  "例如：共同创业、表姐弟、摄影搭档": "e.g. co-founders, cousins, photography partners",
  关系标签建议: "Relation suggestions",
  确认建立: "Create relation",
  已建立关系: "Relation created",
  与: "and",
  起点和终点不能是同一个人: "Start and end must be different people",
  请选择关系起点: "Pick the relation start",
  请选择关系终点: "Pick the relation end",
  "连线模式：依次点击两个节点，按住节点仍可拖动":
    "Link mode: click two nodes in order; drag still moves a node",
  "单击节点聚焦并淡化无关人物，双击打开人物卡，按住可拖动":
    "Click to focus and dim unrelated people; double-click for the profile; drag to move",
  点击选择为关系起点或终点: "Click to use as the relation start or end",
  "单击聚焦，拖动可移动，双击开人物卡":
    "Click to focus, drag to move, double-click for the profile",
  亲属: "Relative",
  夫妻: "Spouses",
  合作伙伴: "Partners",
  ...
  "写下目标后，智能体会按需读取人物、关系和事件，形成可编辑草案；只有你批准的行动项才会写入计划。":
    "Describe a goal and the agent will read relevant people, relationships and events on demand. Only the action items you approve are saved.",
  "目标，例如：筹备校园记忆展开幕活动":
    "Goal, e.g. prepare the opening of a campus memory exhibition",
  正在拆解: "Planning…",
  智能体拆解任务: "Ask agent to plan",
  规划轨迹: "Planning activity",
  已生成待批准行动草案: "Generated action drafts for approval",
  行动规划失败: "Action planning failed",
  待批准行动草案: "Action drafts awaiting approval",
  "可以改写、取消选择或调整日期，再一次性加入计划。":
    "Edit, deselect or reschedule the drafts, then add the selected items in one step.",
  放弃草案: "Discard drafts",
  批准并加入计划: "Approve and add",
  选择此行动项: "Select this action item",
  行动项标题: "Action title",
  行动项说明: "Action details",
  计划完成日期: "Due date",
  默认负责人: "Default assignee",
  手动添加行动项: "Add an action item manually",
  "交付结果、背景和注意事项（可留空）": "Expected outcome, context and cautions (optional)",
  已加入行动计划: "Added to the action plan",
  至少选择一条有标题的行动项: "Select at least one action item with a title",
  已批准并加入行动计划: "Approved and added to the action plan",
  用户批准了智能体生成并经人工编辑的行动草案:
    "The user approved the agent-generated action drafts after editing",
  用户批准此行动项: "The user approved this action item",
  行动计划写入失败: "Failed to save the action plan",
  本次批准已作为一个事务写入: "This approval was saved as one transaction",
  撤销本次批准: "Undo this approval",
  已撤销本次批准: "This approval has been undone",
  撤销失败: "Undo failed",
  正在写入: "Saving",
  把目标变成: "Turn a goal into ",
  下一步行动: "next actions",
  "这一页：拆解目标、核对草案、推进任务":
    "On this page: plan goals, review drafts and move work forward",
  "写下一个真实目标，智能体会按需读取相关人物、关系与事件。":
    "Describe a real goal and the agent will read relevant people, relationships and events on demand.",
  "生成结果先成为可编辑草案，只有你批准的内容才会进入行动计划。":
    "Results first become editable drafts; only approved items enter the action plan.",
  "任务可以继续分配负责人、调整状态和截止日期。":
    "Assign owners and continue updating task status and deadlines.",
  ...
  问这个: "Ask this",
  关系网视图: "Relationship graph view",
  "概览：结构骨架": "Overview: structural backbone",
  ...
  朋友关系: "Friends",
  其它关系: "Other",
  关系证据筛选: "Filter relationship evidence",
  全部证据模式: "All evidence modes",
  材料明确: "Explicit in source",
  推导关系: "Inferred relationship",
  旧数据待识别: "Legacy data to classify",
  确认状态筛选: "Filter confirmation status",
  全部确认状态: "All confirmation states",
  当前视图显示: "Current view shows",
  "条关系，隐藏": "relationships and hides",
  条: "relationships",
  临时查看全部: "Show all temporarily",
  "常隐只影响画面，不会删除关系。": "Always hidden only affects the view; it does not delete data.",
  证据模式: "Evidence mode",
  置信度未知: "confidence unknown",
  关系图展示: "Graph visibility",
  常显: "Always show",
  常隐: "Always hide",
  引荐推荐策略: "Referral policy",
  允许用于推荐: "Allow in recommendations",
  ...
  恢复待办: "Reopen to-do",
  完成待办: "Complete to-do",
  搜索参与人物: "Search participants",
  没有找到匹配的人物: "No matching people",
  补记结果: "Add outcome",
  查看结果: "View outcome",
  这件事最后怎么样了: "What happened in the end?",
  "例如：已经把清单发给唐悦，她说明天确认档期":
    "For example: I sent Tang Yue the checklist; she will confirm the schedule tomorrow",
  稍后再记: "Add later",
  保存到时间线: "Save to timeline",
  结果已记入时间线: "Outcome saved to timeline",
  ...
  说明: "Help",
  材料格式与上限: "File formats and limits",
  录音与转写: "Recording and transcription",
  输入内容已自动暂存: "Your input is auto-saved",
  圈层变更: "Circle changes",
  如果还能提供这些信息会更好: "These details would help, if you have them",
  来源可能对不上的关系也一起接受: "Also accept relations whose source may not line up",
  "再把来源可能对不上的关系也一起接受吗？它们在档案里会保留待核验标记，之后随时可以改。":
    "Accept the relations whose source may not line up as well? They stay marked as pending review, and you can change them anytime.",
  移出圈层: "Remove from circle",
  加入已有圈层: "Add to an existing circle",
  "加入已有圈层…": "Add to an existing circle…",
  新建圈层: "New circle",
  已加入圈层: "Added to circle",
  未命名圈层: "Untitled circle",
  "AI 推断，未找到原文依据：": "AI-inferred, no source text found:",
  "AI 整理人物圈层（测试功能）": "AI organises circles (experimental)",
  "先确认给 AI 的要求，再让它读本机档案提出圈层方案；写入之前你还能逐条修改。":
    "Confirm the instruction first, then let AI read this device's archive and propose circles. You can still edit every entry before writing.",
  整理圈层的提示词: "Instruction for organising circles",
  "让 AI 提出方案": "Let AI propose circles",
  重新提出方案: "Propose again",
  恢复默认提示词: "Restore default instruction",
  跳过这个圈层: "Skip this circle",
  没在档案里找到: "Not found in the archive",
  确认写入圈层: "Write circles",
  还没有可写入的圈层: "No circle is ready to write",
  已写入圈层: "Circles written",
  个新圈层: "new circles",
  条成员关系: "memberships",
  "通读本机档案后，用大白话讲清：整体结构、每个人的关键标签、谁把不同群体连起来、还缺哪些信息。":
    "After reading this device's archive, explain in plain words: the overall structure, each person's key labels, who links different groups, and what is still missing.",
  "档案依据与待确认项（展开查看）": "Archive evidence and pending items (expand)",
  "这里只依据本地的共同事件记录计算：超过 90 天没有共同事件的人会出现在这里。":
    "This uses local shared-event records only: people without a shared event in the last 90 days show up here.",
  "暂无超过 90 天未互动的人物。": "Nobody has gone more than 90 days without contact.",
  ...
  有AI推断关系待核验: "AI-inferred relationships need review",
  "下方「新关系」已自动展开。逐条核对来源，接受、修改或拒绝后再确认入库。":
    "The “New relationships” section is expanded below. Check each source and accept, edit, or reject before saving.",
  条待核验: "to review",
  人物卡片: "Person cards",
